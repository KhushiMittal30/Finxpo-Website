...
const Day3 = () => {
  ...
  //   const target = document.querySelector(`.p-timeline-content3[data-car="${itemId}"]`);
  //   if (target) {
...
<div className="timeline-wrap">
  <h2 className="timeline-title ubuntu-bold" style={{fontSize:"70px", marginBottom:"30px"}}></h2>
  {/* <hr /> */}
  ...
  <ul className="timeline">
    {[
      { idd: 13, date: "Opening Ceremony", label: "time" },
      { idd: 14, date: "Speaker Session", label: "Item 2" },
      { idd: 15, date: "Blockchain Workshop", label: "Item 3" },
      { idd: 16, date: "Fireside Chat", label: "Item 4" },
      { idd: 17, date: "Elevator Pitch", label: "Item 4" },
      { idd: 18, date: "Networking Dinner", label: "Item 4" },
    ].map(({ idd, date, label }) => (
      <li
        key={idd}
