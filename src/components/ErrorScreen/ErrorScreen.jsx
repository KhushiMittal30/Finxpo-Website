...
export default function ErrorScreen() {
  ...
  useEffect(() => {
    ...
    setShowError(window.innerWidth < 600);
      ...
      <AnimatePresence>
        {showError && (
          ...
          >
            ...
            >
              This website requires a screen width of at least 600 pixels for the best experience. Please rotate your
              device or switch to a larger screen.
            </motion.p>
            ...
            >
              ...
              Required: <span className="font-mono">600px</span>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
