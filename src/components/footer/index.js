                ...
                <div className="w-full px-8 py-16 gradient-footer rounded-lg box-border border-0 ">
                            ...
                            <div className="box-border border-0">
                                ...
                                <ul className="m-0 p-0 list-none text-gray-400 font-medium box-border border-0">
                                    <li className="mb-3 box-border border-0">
                                        <a href="https://www.instagram.com/finxpo.mitwpu?igsh=MWpleDlqdjVqaHhzeg==](https://www.instagram.com/finxpo.mitwpu?igsh=MWpleDlqdjVqaHhzeg==) " className="text-gray-300 hover:underline box-border border-0 hover:text-white">Instagram</a>
                                    </li>
                                    <li className="mb-3 box-border border-0">
                                        <a href="#" className="text-gray-300 hover:underline box-border border-0 hover:text-white">Twitter</a>
                                    </li>
                                    <li className="box-border border-0">
                                        <a href="#" className="text-gray-300 hover:underline box-border border-0 hover:text-white">LinkedIn</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="sm:flex sm:justify-between sm:items-center box-border border-0">
                        ...
                        <div className="flex sm:mt-0 sm:justify-center mt-4 box-border border-0">
                            <a href="#" className="text-gray-300 box-border no-underline border-0 hover:text-white">
                            ...
                            <a href="#" className="ml-5 text-gray-300 no-underline box-border border-0 hover:text-white ">
                            ...
                            <a href="https://www.instagram.com/finxpo.mitwpu?igsh=MWpleDlqdjVqaHhzeg==](https://www.instagram.com/finxpo.mitwpu?igsh=MWpleDlqdjVqaHhzeg==) https://www.instagram.com/ride.mitwpu?igsh=MTZxaTBtYmhjcm1lYQ==" className="ml-5 text-gray-300 no-underline box-border border-0 hover:text-white">
                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="block w-4 h-4 align-middle box-border border-0">
